...
def test_pilot_closeout_report_pack_success_sources_still_manual_review(tmp_path: Path) -> None:
    ...
    _write_json(evidence, {"status": "success", "version": "3.6.0", "read_only": True, "real_llm_executed": False, "manifest_id": "m1", "total_files": 3})
    _write_json(readiness, {"readiness_status": "ready", "version": "3.6.0", "read_only": True, "real_llm_executed": False, "integrations": [{"readiness_status": "ready"}]})
    _write_json(scoring, {"status": "success", "version": "3.6.0", "read_only": True, "real_llm_executed": False, "overall_score": 92, "risk_level": "low", "dimension_scores": [{"status": "success"}]})
    _write_json(dry_run, {"status": "success", "version": "3.6.0", "read_only": True, "real_llm_executed": False, "integrations": [{"readiness_status": "ready"}]})
    _write_json(exceptions, {"status": "success", "version": "3.6.0", "read_only": True, "real_llm_executed": False, "exception_count": 1, "auto_approved": False})
