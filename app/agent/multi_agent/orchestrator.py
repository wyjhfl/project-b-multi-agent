...
class MultiAgentOrchestrator:
    ...
    def run(
        ...
        self._trace("executor_completed", task_id, success=execution_result.get("success", False), executed_mode=execution_result.get("executed_mode", selected_mode))
        ...
        if not review_result["approved"] and review_result.get("suggested_fallback_mode"):
            ...
            self._trace("executor_completed", task_id, success=fb_execution_result.get("success", False), executed_mode=fallback_mode, fallback=True)
