...
DEFAULT_TARGETS = [
    ...
    ROOT_DIR / "docs" / "evidence_archive_manifest_v34.md",
    ROOT_DIR / "docs" / "controlled_pilot_run_packet_v49.md",
    ROOT_DIR / "docs" / "controlled_pilot_demo_landing_v49.md",
    ...
    ROOT_DIR / "docs" / "interview_demo_readiness_v50.md",
    ROOT_DIR / "docs" / "demo_business_read_only_interface_v49.md",
    ROOT_DIR / "docs" / "production_landing_precommit_closeout_v49.md",
    ...
    ROOT_DIR / "scripts" / "production_landing_blocker_resolution.py",
    ...
    ROOT_DIR / "scripts" / "controlled_pilot_run_packet.py",
    ROOT_DIR / "scripts" / "controlled_pilot_demo_landing.ps1",
    ROOT_DIR / "scripts" / "interview_demo_readiness.py",
    ROOT_DIR / "scripts" / "production_landing_precommit_closeout.py",
